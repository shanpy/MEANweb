...
angular.module('webappApp')
  .controller('MainCtrl', function ($scope, $http, $timeout,$animate) {
  	...
  	$scope.slides = [
  	{
  		...
  		content: "<p>During the week of May 26th, 2014, I re-designed website layout.</p><p>Scrrenshot left is how website looks previously.</p><p>I really like this design and I decide to continue using it in blog section.</p>"
